...
eval $(python3 /export/home/sheid/PixArt-sigma/distillation/parse_yaml.py /export/home/sheid/MasterThesis_Evaluation/configs/PixArt/config_distillation.yaml)
...
for gpu in "${available_gpus[@]}"; do
  export CUDA_VISIBLE_DEVICES=$gpu
 python -m torch.distributed.launch --nproc_per_node=1 --master_port=12336 \
          /export/home/sheid/PixArt-sigma/train_scripts/train.py \
...
for gpu in "${available_gpus[@]}"; do
CUDA_VISIBLE_DEVICES=${gpu} python /export/home/sheid/PixArt-sigma/tools/convert_pixart_to_diffusers_distillation.py --config_path /export/home/sheid/MasterThesis_Evaluation/configs/PixArt/config_distillation.yaml
done
...
for gpu in "${available_gpus[@]}"; do
  export CUDA_VISIBLE_DEVICES=$gpu
python  /export/home/sheid/MasterThesis_Evaluation/block_analysis_distillation.py
done
