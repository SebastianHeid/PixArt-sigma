...
# print(only_files)
path = "/export/data/sheid/unsplash/data_info.json"
with open(path, "r") as file:
    ...
    idx2 = 0
    for idx, e in tqdm(enumerate(data)):
        if idx == 1000000:
            break
        el_dict.append(e)
        
path2="/export/data/sheid/unsplash/data_info_1Mio.json"   
with open(path2, "w") as file2:
    json.dump(el_dict, file2, indent=4)