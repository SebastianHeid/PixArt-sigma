...
fp32_attention = True
load_from = "/export/data/sheid/pixart/PixArt_sigma_xl2_img512_laion2M_skipConnection/checkpoints/epoch_1_step_127226.pth"  # https://huggingface.co/PixArt-alpha/PixArt-Sigma
