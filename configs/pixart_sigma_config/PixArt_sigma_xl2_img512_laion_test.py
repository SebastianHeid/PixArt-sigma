...
load_from = "/export/data/sheid/pixart/third_pruning_attempt/PixArt_sigma_xl2_img512_laion_17_15_8_20_12_16_21_11_7_18_4_13_5_23_finetuning/checkpoints/epoch_1_step_37990.pth" 
resume_from = None
vae_pretrained = (
...
transformer_blocks = [4,3,5]
trainable_blocks = []
# wenn ich hier eine Block hinzufüge, dann funktioniert es nicht mehr

# If Attention Features are used for loss computation
self_att_feat_loss_flag = True