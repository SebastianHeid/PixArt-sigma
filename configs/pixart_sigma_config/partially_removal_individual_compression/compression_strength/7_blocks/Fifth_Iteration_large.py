...
pruned_load_from =   "/export/data/sheid/pixart/partially_removal_individual_compression/compression_strength/7_blocks/Fourth_Iteration_finetuning_pixart/checkpoints/epoch_2_step_12500.pth" 
...
transformer_blocks = []
trainable_blocks = [11, 18, 13, 8, 22, 14, 7]
