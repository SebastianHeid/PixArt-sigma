...
pruned_load_from =   "/export/data/sheid/pixart/partially_removal_individual_compression/compression_strength/14_blocks/First_Iteration_finetuning_pixart/checkpoints/epoch_1_step_6251.pth" 
...
transformer_blocks = []
trainable_blocks = [21, 7, 4, 27, 0, 1, 19, 5, 9, 16, 2, 25, 8, 3]
