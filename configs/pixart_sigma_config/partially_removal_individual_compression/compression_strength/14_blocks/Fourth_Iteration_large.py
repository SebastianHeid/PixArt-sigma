...
pruned_load_from =   "/export/data/sheid/pixart/partially_removal_individual_compression/compression_strength/14_blocks/Third_Iteration_finetuning_pixart/checkpoints/epoch_2_step_12500.pth" 
...
transformer_blocks = []
trainable_blocks = [18, 5, 7, 26, 1, 6, 3, 4, 16, 21, 17, 10, 11, 15]
