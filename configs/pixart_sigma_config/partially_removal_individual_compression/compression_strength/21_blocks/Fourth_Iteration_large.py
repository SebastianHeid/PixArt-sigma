...
pruned_load_from =   "/export/data/sheid/pixart/partially_removal_individual_compression/compression_strength/21_blocks/Third_Iteration_finetuning_pixart/checkpoints/epoch_2_step_12500.pth" 
...
transformer_blocks = []
trainable_blocks = [23, 6, 7, 0, 5, 1, 27, 2, 4, 18, 16, 17, 8, 19, 14, 11, 25, 20, 10, 9, 22]
