...
pruned_load_from =   "/export/data/sheid/pixart/partially_removal_individual_compression/compression_strength/21_blocks/First_Iteration_finetuning_pixart/checkpoints/epoch_2_step_12500.pth" 
...
transformer_blocks = []
trainable_blocks = [16, 27, 7, 4, 6, 1, 0, 2, 9, 21, 5, 19, 17, 11, 10, 3, 26, 20, 13, 25, 22]
