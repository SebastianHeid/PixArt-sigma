...
load_from = '/export/data/sheid/pixart/second_pruning_attempt/PixArt_sigma_xl2_img512_laion_17_15_8_20_11_16_12_23_21_finetuning/checkpoints/epoch_1_step_38000.pth'
resume_from = None
vae_pretrained = (
...
intermediate_loss_blocks = [8, 9, 12, 13, 17, 18, 21, 23, 24, 25]
final_output_loss_flag = True
org_loss_flag = False

# Modfication of Model
transformer_blocks = [17, 15, 8, 20, 11, 16, 12, 23, 21]
trainable_blocks = []
