...
fp32_attention = True
load_from = "/export/data/sheid/pixart/second_pruning_attempt/PixArt_sigma_xl2_img512_laion_17/checkpoints/epoch_1_step_11.pth"  # https://huggingface.co/PixArt-alpha/PixArt-Sigma
