...
fp32_attention = True
load_from = "/gpfs/bwfor/work/ws/hd_om233-flux/pixart/model_distillation/partially_block_removal/First_Iteration_finetuning_on_pixart/checkpoints/epoch_2_step_12500.pth"  # https://huggingface.co/PixArt-alpha/PixArt-Sigma
pruned_load_from =  "/gpfs/bwfor/work/ws/hd_om233-flux/pixart/model_distillation/partially_block_removal/First_Iteration_finetuning_on_pixart/checkpoints/epoch_2_step_12500.pth"
...
transformer_blocks = []
trainable_blocks =  [0, 1, 3, 4, 5, 7,16, 6, 25, 11, 21]
# wenn ich hier eine Block hinzufüge, dann funktioniert es nicht mehr


#Compress mlp, attn, cross_attn via SVD

transformer_blocks_mlp = [0, 1, 3, 4, 5, 7,16, 6, 25, 11, 21]
rank_mlp = 512

transformer_blocks_attn = [0, 1, 3, 4, 5, 7,16, 6, 25, 11, 21]
rank_attn = 128

transformer_blocks_cross_attn =  [0, 1, 3, 4, 5, 7,16, 6, 25, 11, 21]
rank_cross_attn = 128