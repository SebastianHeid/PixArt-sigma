...
fp32_attention = True
load_from = "/gpfs/bwfor/work/ws/hd_om233-flux/pixart/model_distillation/partially_block_removal/Second_Iteration_large_finetuning_on_pixart/checkpoints/epoch_2_step_12500.pth"  # https://huggingface.co/PixArt-alpha/PixArt-Sigma
pruned_load_from =  "/gpfs/bwfor/work/ws/hd_om233-flux/pixart/model_distillation/partially_block_removal/Second_Iteration_large_finetuning_on_pixart/checkpoints/epoch_2_step_12500.pth"
...
transformer_blocks = []
trainable_blocks = [15, 11, 9]
# wenn ich hier eine Block hinzufüge, dann funktioniert es nicht mehr


#Compress mlp, attn, cross_attn via SVD

transformer_blocks_mlp = [4, 0, 3, 1, 5, 7, 25, 27, 2, 6, 18, 20, 8, 16, 21, 15, 11, 9]
rank_mlp = 512

transformer_blocks_attn = [4, 0, 3, 1, 5, 7, 25, 27, 2, 6, 18, 20, 8, 16, 21, 15, 11, 9]
rank_attn = 128

transformer_blocks_cross_attn =  [4, 0, 3, 1, 5, 7, 25, 27, 2, 6, 18, 20, 8, 16, 21, 15, 11, 9]
rank_cross_attn = 128