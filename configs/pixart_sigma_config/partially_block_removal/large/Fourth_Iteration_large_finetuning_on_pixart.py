...
fp32_attention = True
load_from = "/gpfs/bwfor/work/ws/hd_om233-flux/pixart/model_distillation/partially_block_removal/Fourth_Iteration_large_finetuning/checkpoints/epoch_1_step_38000.pth"  # https://huggingface.co/PixArt-alpha/PixArt-Sigma
pruned_load_from =  "/gpfs/bwfor/work/ws/hd_om233-flux/pixart/model_distillation/partially_block_removal/Fourth_Iteration_large_finetuning/checkpoints/epoch_1_step_38000.pth"
