...
fp32_attention = True
load_from = "/gpfs/bwfor/work/ws/hd_om233-flux/pixart/model_distillation/partially_block_removal/mlp/First_Iteration_finetuning_on_pixart/checkpoints/epoch_2_step_12500.pth"  # https://huggingface.co/PixArt-alpha/PixArt-Sigma
pruned_load_from =  "/gpfs/bwfor/work/ws/hd_om233-flux/pixart/model_distillation/partially_block_removal/mlp/First_Iteration_finetuning_on_pixart/checkpoints/epoch_2_step_12500.pth"
...
transformer_blocks = []
trainable_blocks = [ 7, 15, 17, 14, 25, 11]
# wenn ich hier eine Block hinzufüge, dann funktioniert es nicht mehr


#Compress mlp, attn, cross_attn via SVD

transformer_blocks_mlp = [1, 3, 0, 6, 2, 19, 4, 16, 22, 8, 27, 5, 20, 18, 7, 15, 17, 14, 25, 11]
rank_mlp = 512
