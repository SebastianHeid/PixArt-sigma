...
fp32_attention = True
load_from = "/gpfs/bwfor/work/ws/hd_om233-flux/pixart/model_distillation/partially_block_removal/First_Iteration_finetuning/checkpoints/epoch_1_step_38000.pth"  # https://huggingface.co/PixArt-alpha/PixArt-Sigma
pruned_load_from =  "/gpfs/bwfor/work/ws/hd_om233-flux/pixart/model_distillation/partially_block_removal/First_Iteration_finetuning/checkpoints/epoch_1_step_38000.pth"
...
transformer_blocks_mlp = [0, 1, 3, 4, 5, 7]
rank_mlp = 512

transformer_blocks_attn = [0, 1, 3, 4, 5, 7]
rank_attn = 128

transformer_blocks_cross_attn =  [0, 1, 3, 4, 5, 7]
rank_cross_attn = 128