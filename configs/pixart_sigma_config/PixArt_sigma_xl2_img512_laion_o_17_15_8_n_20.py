...
fp32_attention = True
load_from = "/export/data/sheid/pixart/PixArt_sigma_xl2_img512_laion_17_15_8_finetuning_train_on_pixart_generated_images_all_feat/checkpoints/epoch_2_step_12501.pth"  # https://huggingface.co/PixArt-alpha/PixArt-Sigma
...
# training setting
num_workers = 0
train_batch_size = 16 # using 2 gpus, so 8 is 16 in total
num_epochs = 2  # 3
...
intermediate_loss_blocks = [20]
final_output_loss_flag = True
org_loss_flag = False

# Modfication of Model
transformer_blocks = [8,15,17, 20]
trainable_blocks = [19]
