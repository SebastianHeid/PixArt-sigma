...
fp32_attention = True
load_from = "//export/data/sheid/pixart/PixArt_sigma_xl2_img512_laion_o_17_15_8_n_20_11_finetuning/checkpoints/epoch_1_step_38070.pth"  # https://huggingface.co/PixArt-alpha/PixArt-Sigma
...
# training setting
num_workers = 0
train_batch_size = 8  # because 2 gpus were used for training
num_epochs = 2  # 3
...
intermediate_loss_blocks = [8,9,11,12,13,15,17,18,20,21,22,23,24,25,26,27]
