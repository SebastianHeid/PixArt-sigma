...
fp32_attention = True
load_from = "/export/data/sheid/pixart/PixArt_sigma_xl2_img512_laion_5_11_17_23_corrected_loss_finetuned/checkpoints/epoch_1_step_304707.pth"  # https://huggingface.co/PixArt-alpha/PixArt-Sigma
...
intermediate_loss_blocks = [5,7,8,9,11,12,13,15,17,19,21,23,24,25,26,27]
final_output_loss_flag = True
org_loss_flag = False

# Modfication of Model
transformer_blocks = [5,7,11,15,17,19,21,23]
trainable_blocks = [6,14,18,20]
