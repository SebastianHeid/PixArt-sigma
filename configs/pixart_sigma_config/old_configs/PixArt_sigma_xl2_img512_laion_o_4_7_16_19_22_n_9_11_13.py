...
fp32_attention = True
load_from = "/export/data/sheid/pixart/PixArt_sigma_xl2_img512_laion_4_7_16_19_22_finetuning/checkpoints/epoch_1_step_304707.pth"  # https://huggingface.co/PixArt-alpha/PixArt-Sigma
...
intermediate_loss_blocks = [4,5,7,9,11,13,14,16,17,19,20,22,23,24,25,26,27]
final_output_loss_flag = True
org_loss_flag = False

# Modfication of Model
transformer_blocks = [4,7,9,11,13,16,19,22]
trainable_blocks = [8,10,12]
