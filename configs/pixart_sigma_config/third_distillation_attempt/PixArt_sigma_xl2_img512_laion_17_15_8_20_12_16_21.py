...
fp32_attention = True
load_from = "/export/data/sheid/pixart/third_pruning_attempt/PixArt_sigma_xl2_img512_laion_17_15_8_20_12_16_finetuning_trained_on_pixart_generated_images/checkpoints/epoch_2_step_12500.pth"  # https://huggingface.co/PixArt-alpha/PixArt-Sigma
...
intermediate_loss_blocks = [21,22,23,24,25,26,27]
final_output_loss_flag = True
org_loss_flag = False

# Modfication of Model
transformer_blocks = [8,15,17, 20, 12, 16, 21]
trainable_blocks = [19]
